...
// Note: Wardrobe Item API calls have been moved to services/wardrobe/items

// Outfit API calls - MOVED to services/wardrobe/outfits/outfitService.ts
// To use outfits functionality, import from services/wardrobe/outfits
/* Example:
import { fetchOutfits, createOutfit, updateOutfit, deleteOutfit } from '../services/wardrobe/outfits';
*/

// createOutfit has been moved to services/wardrobe/outfits/outfitService.ts

// updateOutfit has been moved to services/wardrobe/outfits/outfitService.ts

// deleteOutfit has been moved to services/wardrobe/outfits/outfitService.ts
